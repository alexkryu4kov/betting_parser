...
from src.main_data_parsers.entity import MatchInfo
...
class ParserWithoutResult:
    ...
    def get_match_info(self):
        ...
        home_handicap_minus_15_first, away_handicap_minus_15_first = self._extract_handicap(self._handicap_page_first,
                                                                                            'P--1.50-0-0')
        home_handicap_minus_1_first, away_handicap_minus_1_first = self._extract_handicap(self._handicap_page_first,
                                                                                          'P--1.00-0-0')
        home_handicap_plus_15_first, away_handicap_plus_15_first = self._extract_handicap(self._handicap_page_first,
                                                                                          'P-1.50-0-0')
        home_handicap_plus_1_first, away_handicap_plus_1_first = self._extract_handicap(self._handicap_page_first,
                                                                                        'P-1.00-0-0')
        home_handicap_0_second, away_handicap_0_second = self._extract_handicap(self._handicap_page_second,
                                                                                'P-0.00-0-0')
        home_handicap_minus_15_second, away_handicap_minus_15_second = self._extract_handicap(
            self._handicap_page_second, 'P--1.50-0-0')
        home_handicap_minus_1_second, away_handicap_minus_1_second = self._extract_handicap(self._handicap_page_second,
                                                                                            'P--1.00-0-0')
        home_handicap_plus_15_second, away_handicap_plus_15_second = self._extract_handicap(self._handicap_page_second,
                                                                                            'P-1.50-0-0')
        home_handicap_plus_1_second, away_handicap_plus_1_second = self._extract_handicap(self._handicap_page_second,
                                                                                          'P-1.00-0-0')
